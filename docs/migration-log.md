...
- El detalle de electiva ya no cambia de grupo por detras. Ahora trabaja siempre sobre el grupo abierto por el usuario.
- Las opciones de electiva se enriquecieron para parecerse mas a una materia normal:
  - resumen
  - explicacion simple
...
## Actualizacion 2026-03-22 - Reparacion de textos rotos
...
## Actualizacion 2026-03-23 - Cierre de busqueda diferenciado segun la posicion real de la pantalla

- `Malla` ahora registra si la busqueda se abrio estando arriba del todo o no.
- Durante el cierre:
